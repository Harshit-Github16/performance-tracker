...
export default function DashboardLayout({ children }) {
  ...
  const navigation = [
    ...
    {
      name: "Metrics", href: "/metrics", superAdminOnly: true,
            ...
            {user?.role !== "super_admin" ? (
              <div className="flex items-center space-x-2 md:space-x-4 min-w-0">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  >
                    <h2 className="text-sm md:text-[15px] font-bold text-gray-950 tracking-[0.05em] uppercase opacity-95 leading-none truncate">{mounted && activeIp?.name ? activeIp.name : "Loading..."}</h2>
                    {user?.ips?.length > 1 && (
              ...
              {isProfileOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-12 w-48 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                    ...
                    <button
                      onClick={() => { setIsProfileOpen(false); setIsChangePasswordOpen(true); setPasswordForm({ current: "", password: "", confirm: "" }); }}
              ...
              <form onSubmit={handleChangePassword} className="p-6 space-y-4">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    <button type="button" onClick={() => setShowCurrentPassword(!showCurrentPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-950 transition-colors">
                      {showCurrentPassword
