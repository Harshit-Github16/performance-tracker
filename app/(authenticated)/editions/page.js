...
export default function EditionsPage() {
    ...
    const canView = hasPermission("editions:view", user);
    const canAdd = hasPermission("editions:add", user);
    const canEdit = hasPermission("editions:edit", user);
    const canDelete = hasPermission("editions:del", user);
            ...
            {!canView ? (
                <div className="w-full bg-white rounded-2xl border border-gray-100/50 shadow-[0_20px_60px_rgba(0,0,0,0.02)] p-12">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-xs text-gray-400">You don&apos;t have permission to view editions.</p>
                    </div>
                </div>
            ) : (
                <>
