...
export function AuthProvider({ children }) {
    ...
    try {
      ...
      const authenticatedUser = {
        ...
        avatar_initials: userData.full_name
          ...
          .toUpperCase()
          .slice(0, 3),
        ips: [], // will be populated after my-properties fetch
      };
  ...
  // Call this after fetching my-properties to update ips in context + storage
  ...
  return (
    <AuthContext.Provider value={{ user, login, logout, loading, updateUserIps }}>
      {children}
